...
/**
 * The Nomad - Wanderer putting down roots
 * Starting labels: Danger 0, Freak +1, Savior +1, Superior -1, Mundane +2
 */
export const NOMAD = StubActor.withLabels(
	{ danger: 0, freak: 1, savior: 1, superior: -1, mundane: 2 },
	{
		id: "char-nomad-001",
		name: "Nomad",
		system: {
			playbook: { name: "The Nomad" },
		} as any,
	},
);
 ...
 * Starting labels: Danger +1, Freak +1, Savior -1, Superior +2, Mundane 0
 */
export const REFORMED = StubActor.withLabels(
	{ danger: 1, freak: 1, savior: -1, superior: 2, mundane: 0 },
	{
		id: "char-reformed-001",
		name: "Reformed",
		system: {
			playbook: { name: "The Reformed" },
		} as any,
	},
);

/**
 * The Harbinger - Time-displaced hero
 * Starting labels: Danger 0, Freak +2, Savior +1, Superior +1, Mundane -1
 */
export const HARBINGER = StubActor.withLabels(
	{ danger: 0, freak: 2, savior: 1, superior: 1, mundane: -1 },
	{
		id: "char-harbinger-001",
		name: "Harbinger",
		system: {
			playbook: { name: "The Harbinger" },
		} as any,
	},
);
